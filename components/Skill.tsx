  ...
  return (
    <div className="group relative flex cursor-pointer">
      <motion.img
        ...
        alt="Skill Icon"
        className="rounded-full border border-gray-500 object-cover w-14 h-14 sm:w-20 sm:h-20 md:w-24 md:h-24 xl:w-28 xl:h-28 filter group-hover:grayscale transition duration-300 ease-in-out"
      />
